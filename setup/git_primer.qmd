...
- Go to the Github Repository you want to commit changes to and create a fork. 
- Clone the fork to your local machine as if it was a normal remote repository. 
...
- Add the original repository as another remote repository. 
This repository is usually referred to as `upstream`:
...
- Check the remote repositories again `git remote -v`
- Create a branch, make changes, commit 
- push changes to a new remote branch of the fork
