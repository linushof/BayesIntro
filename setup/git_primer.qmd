...
Being a collection of values, you can think of a vector as either a row or a column in a table or data frame.
Data frames are the usual data structure that we store our data for analysis in. 
