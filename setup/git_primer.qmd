...
There will be a lot more to learn and do with vectors.
However, for now, we turn again to a bit more complex data structure, one which entails multiple vectors.
